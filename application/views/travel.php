...
<head>
	...
	<script>
		...
		$(function () {
            ...
            //         $('.page-num-link[page-num-link-index='+indexs+']').prop("href","http://www.restlife.shop/Travel/listAll/1");
            //     }
            // });
        });
	</script>
...
<div class="all_wrap">
	...
	<div class="cpage main2" id="main2">
		...
		<div class="sub_title">
			...
			<a class="btn_sub" href="http://www.restlife.shop/Travel/write">글쓰기 <i class="fa fa-caret-right"></i></a>
		</div>
		<div class="sub_title">
						...
						if($k2 == 'dir'){
							if($v2=='travel'){
								...
								<div class="swiper-slide">
									<a href="http://www.restlife.shop/Travel/lists/<?= $img_get[$k]['index'] ?>"><img width="300px;" height="500px;" src="http://www.restlife.shop/lsm/img/<?=$img_get[$k]['dir']?>/<?=$img_get[$k]['jpg_name']?>" class="swiper-lazy"></a>
								</div>
								<?php
								}else if($img_get[$k]['jpg_src']){
								?>
								<div class="swiper-slide">
									<a href="http://www.restlife.shop/Travel/lists/<?= $img_get[$k]['index'] ?>"><img width="300px;" height="500px;" src="<?=$img_get[$k]['jpg_src']?>" class="swiper-lazy"></a>
								</div>
								<?php
								}
							}
                        ...
                        foreach ($v as $k2 =>$v2){
                            if($k2 == 'dir'){
                                if($v2 == 'travel'){
                                    ...
                                    <li class="goods_item">
                                        <div class="img">
                                            <a href="http://www.restlife.shop/Travel/lists/<?= $img_get[$k]['index'] ?>" class="img_link" id="img_link<?=$k?>" >
                                        ...
                                        <a href="#" class="goods_item_link">
                                            ...
                                            <span class="price">
                                    <?= isset($img_get[$k]['reg_date'])?$img_get[$k]['reg_date']:"" ?>
<!--									<span class="dc_price">-->
	...
	<script>
		$(document).ready(function (){
			...
			function return_index(){
				...
				//alert( ($('div .swiper-container .swiper-slide').length) );
				//alert(($('div.' + div_elmt + '.swiper-slide:not(.swiper-slide-duplicate)').length));
