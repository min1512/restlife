...
class Tistory_api {
	...
	public function access_token ($code) {
		...
		$url = $this->api_url.'oauth/access_token?client_id='.$data['client_id'].'&client_secret='.$data['client_secret'].'&redirect_uri='.$data['redirect_uri'].'&code='.$data['code'].'&grant_type=authorization_code';
